...
var Vega_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "pgc/gateway/vega/v1/vega.proto",
}
...
type VegaFrameDocClient interface {
	...
	Subscribe(ctx context.Context, in *SubscribeReq, opts ...grpc.CallOption) (*empty.Empty, error)
}
...
func (c *vegaFrameDocClient) MessageAck(ctx context.Context, in *MessageAckReq, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
func (c *vegaFrameDocClient) Subscribe(ctx context.Context, in *SubscribeReq, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
type VegaFrameDocServer interface {
	...
	Subscribe(context.Context, *SubscribeReq) (*empty.Empty, error)
...
func (UnimplementedVegaFrameDocServer) MessageAck(context.Context, *MessageAckReq) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method MessageAck not implemented")
}
func (UnimplementedVegaFrameDocServer) Subscribe(context.Context, *SubscribeReq) (*empty.Empty, error) {
