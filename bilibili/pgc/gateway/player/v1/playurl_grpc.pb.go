...
const (
	PlayURL_PlayView_FullMethodName     = "/bilibili.pgc.gateway.player.v1.PlayURL/PlayView"
	PlayURL_Project_FullMethodName      = "/bilibili.pgc.gateway.player.v1.PlayURL/Project"
	PlayURL_LivePlayView_FullMethodName = "/bilibili.pgc.gateway.player.v1.PlayURL/LivePlayView"
)
...
func (c *playURLClient) LivePlayView(ctx context.Context, in *LivePlayViewReq, opts ...grpc.CallOption) (*LivePlayViewReply, error) {
	...
	err := c.cc.Invoke(ctx, PlayURL_LivePlayView_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _PlayURL_LivePlayView_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PlayURL_LivePlayView_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
