...
type SourceContentDto struct {
	...
	// 与天马现有逻辑一致, 0有含义
	// 0:内容 1:广告
	ServerType *wrappers.Int32Value `protobuf:"bytes,5,opt,name=server_type,json=serverType,proto3" json:"server_type,omitempty"`
	// 客户端IP回传拼接
	ClientIp string `protobuf:"bytes,6,opt,name=client_ip,json=clientIp,proto3" json:"client_ip,omitempty"`
	// 广告卡片位置在一刷中的位置, 天马用, 0有含义
	CardIndex *wrappers.Int32Value `protobuf:"bytes,7,opt,name=card_index,json=cardIndex,proto3" json:"card_index,omitempty"`
	// 广告资源位source 位次
...
func (x *SourceContentDto) GetServerType() *wrappers.Int32Value {
	if x != nil {
		return x.ServerType
	}
	return nil
...
func (x *SourceContentDto) GetCardIndex() *wrappers.Int32Value {
	if x != nil {
		return x.CardIndex
	}
	return nil
...
type TabInfoDto struct {
	...
	Extra *any1.Any `protobuf:"bytes,2,opt,name=extra,proto3" json:"extra,omitempty"`
...
func (x *TabInfoDto) GetExtra() *any1.Any {
	if x != nil {
		return x.Extra
	}
	return nil
...
var file_bilibili_ad_v1_ad_proto_goTypes = []interface{}{
	...
	(*wrappers.Int32Value)(nil),      // 50: google.protobuf.Int32Value
	(*any1.Any)(nil),                 // 51: google.protobuf.Any
}
