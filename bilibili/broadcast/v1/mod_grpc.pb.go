...
type ModManagerClient interface {
	WatchResource(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (ModManager_WatchResourceClient, error)
}
...
func (c *modManagerClient) WatchResource(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (ModManager_WatchResourceClient, error) {
...
type ModManagerServer interface {
	WatchResource(*empty.Empty, ModManager_WatchResourceServer) error
...
func (UnimplementedModManagerServer) WatchResource(*empty.Empty, ModManager_WatchResourceServer) error {
