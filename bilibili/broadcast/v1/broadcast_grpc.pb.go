...
func (c *broadcastClient) Auth(ctx context.Context, in *AuthReq, opts ...grpc.CallOption) (*AuthResp, error) {
	out := new(AuthResp)
	err := c.cc.Invoke(ctx, "/bilibili.broadcast.v1.Broadcast/Auth", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *broadcastClient) Heartbeat(ctx context.Context, in *HeartbeatReq, opts ...grpc.CallOption) (*HeartbeatResp, error) {
	...
	err := c.cc.Invoke(ctx, "/bilibili.broadcast.v1.Broadcast/Heartbeat", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *broadcastClient) Subscribe(ctx context.Context, in *TargetPath, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, "/bilibili.broadcast.v1.Broadcast/Subscribe", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *broadcastClient) Unsubscribe(ctx context.Context, in *TargetPath, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/bilibili.broadcast.v1.Broadcast/Unsubscribe", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *broadcastClient) MessageAck(ctx context.Context, in *MessageAckReq, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/bilibili.broadcast.v1.Broadcast/MessageAck", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Broadcast_Auth_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/bilibili.broadcast.v1.Broadcast/Auth",
	}
...
func _Broadcast_Heartbeat_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/bilibili.broadcast.v1.Broadcast/Heartbeat",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Broadcast_Subscribe_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/bilibili.broadcast.v1.Broadcast/Subscribe",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Broadcast_Unsubscribe_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/bilibili.broadcast.v1.Broadcast/Unsubscribe",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Broadcast_MessageAck_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/bilibili.broadcast.v1.Broadcast/MessageAck",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func (c *broadcastTunnelClient) CreateTunnel(ctx context.Context, opts ...grpc.CallOption) (BroadcastTunnel_CreateTunnelClient, error) {
	stream, err := c.cc.NewStream(ctx, &BroadcastTunnel_ServiceDesc.Streams[0], "/bilibili.broadcast.v1.BroadcastTunnel/CreateTunnel", opts...)
	if err != nil {
		return nil, err
	}
