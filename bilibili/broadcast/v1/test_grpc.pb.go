...
type TestClient interface {
	// 监听上报事件
	WatchTestEvent(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (Test_WatchTestEventClient, error)
}
...
func (c *testClient) WatchTestEvent(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (Test_WatchTestEventClient, error) {
...
type TestServer interface {
	// 监听上报事件
	WatchTestEvent(*empty.Empty, Test_WatchTestEventServer) error
...
func (UnimplementedTestServer) WatchTestEvent(*empty.Empty, Test_WatchTestEventServer) error {
...
type Test2Client interface {
	Test(ctx context.Context, in *AddParams, opts ...grpc.CallOption) (*empty.Empty, error)
}
...
func (c *test2Client) Test(ctx context.Context, in *AddParams, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
type Test2Server interface {
	Test(context.Context, *AddParams) (*empty.Empty, error)
...
func (UnimplementedTest2Server) Test(context.Context, *AddParams) (*empty.Empty, error) {
