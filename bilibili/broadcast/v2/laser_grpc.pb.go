...
type LaserClient interface {
	// 监听Laser事件
	WatchEvent(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (Laser_WatchEventClient, error)
}
...
func (c *laserClient) WatchEvent(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (Laser_WatchEventClient, error) {
...
type LaserServer interface {
	// 监听Laser事件
	WatchEvent(*empty.Empty, Laser_WatchEventServer) error
...
func (UnimplementedLaserServer) WatchEvent(*empty.Empty, Laser_WatchEventServer) error {
