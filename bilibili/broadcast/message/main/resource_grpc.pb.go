...
type ResourceClient interface {
	TopActivity(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (Resource_TopActivityClient, error)
}
...
func (c *resourceClient) TopActivity(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (Resource_TopActivityClient, error) {
...
type ResourceServer interface {
	TopActivity(*empty.Empty, Resource_TopActivityServer) error
...
func (UnimplementedResourceServer) TopActivity(*empty.Empty, Resource_TopActivityServer) error {
