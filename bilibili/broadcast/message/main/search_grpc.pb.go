...
type SearchClient interface {
	ChatResultPush(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (Search_ChatResultPushClient, error)
}
...
func (c *searchClient) ChatResultPush(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (Search_ChatResultPushClient, error) {
...
type SearchServer interface {
	ChatResultPush(*empty.Empty, Search_ChatResultPushServer) error
...
func (UnimplementedSearchServer) ChatResultPush(*empty.Empty, Search_ChatResultPushServer) error {
