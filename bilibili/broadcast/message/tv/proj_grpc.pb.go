...
func (c *tvClient) Proj(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (Tv_ProjClient, error) {
	stream, err := c.cc.NewStream(ctx, &Tv_ServiceDesc.Streams[0], "/bilibili.broadcast.message.tv.Tv/Proj", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *tvClient) LiveStatus(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (Tv_LiveStatusClient, error) {
	stream, err := c.cc.NewStream(ctx, &Tv_ServiceDesc.Streams[1], "/bilibili.broadcast.message.tv.Tv/LiveStatus", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *tvClient) Esports(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (Tv_EsportsClient, error) {
	stream, err := c.cc.NewStream(ctx, &Tv_ServiceDesc.Streams[2], "/bilibili.broadcast.message.tv.Tv/Esports", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *tvClient) Publicity(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (Tv_PublicityClient, error) {
	stream, err := c.cc.NewStream(ctx, &Tv_ServiceDesc.Streams[3], "/bilibili.broadcast.message.tv.Tv/Publicity", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *tvClient) LiveSkip(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (Tv_LiveSkipClient, error) {
	stream, err := c.cc.NewStream(ctx, &Tv_ServiceDesc.Streams[4], "/bilibili.broadcast.message.tv.Tv/LiveSkip", opts...)
	if err != nil {
		return nil, err
	}
