...
type FissionClient interface {
	GameNotify(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (Fission_GameNotifyClient, error)
}
...
func (c *fissionClient) GameNotify(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (Fission_GameNotifyClient, error) {
...
type FissionServer interface {
	GameNotify(*empty.Empty, Fission_GameNotifyServer) error
...
func (UnimplementedFissionServer) GameNotify(*empty.Empty, Fission_GameNotifyServer) error {
