...
func (x *CM) GetSourceContent() *any1.Any {
	if x != nil {
...
type CMConfig struct {
	...
	// 广告配置数据(需要二次解包)
	AdsControl *any1.Any `protobuf:"bytes,1,opt,name=ads_control,json=adsControl,proto3" json:"ads_control,omitempty"`
}
...
func (x *CMConfig) GetAdsControl() *any1.Any {
	if x != nil {
		return x.AdsControl
	}
	return nil
...
type Tab struct {
	...
	AdTabInfo *any1.Any `protobuf:"bytes,11,opt,name=ad_tab_info,json=adTabInfo,proto3" json:"ad_tab_info,omitempty"`
}
...
func (x *Tab) GetAdTabInfo() *any1.Any {
	if x != nil {
		return x.AdTabInfo
	}
	return nil
...
type ViewReply struct {
	...
	CmUnderPlayer      *any1.Any                   `protobuf:"bytes,48,opt,name=cm_under_player,json=cmUnderPlayer,proto3" json:"cm_under_player,omitempty"`
...
func (x *ViewReply) GetCmUnderPlayer() *any1.Any {
	if x != nil {
...
var file_bilibili_app_view_v1_view_proto_goTypes = []interface{}{
	...
	(*any1.Any)(nil),                    // 168: google.protobuf.Any
