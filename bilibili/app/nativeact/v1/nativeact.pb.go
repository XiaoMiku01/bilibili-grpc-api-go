...
type DynamicParams struct {
	...
	FeedOffset *anypb.Any `protobuf:"bytes,1,opt,name=feed_offset,json=feedOffset,proto3" json:"feed_offset,omitempty"`
...
func (x *DynamicParams) GetFeedOffset() *anypb.Any {
	if x != nil {
		return x.FeedOffset
	}
	return nil
