...
func (c *galleryInterfaceClient) Ping(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
func (UnimplementedGalleryInterfaceServer) Ping(context.Context, *empty.Empty) (*empty.Empty, error) {
...
func _GalleryInterface_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GalleryInterfaceServer).Ping(ctx, req.(*empty.Empty))
	}
