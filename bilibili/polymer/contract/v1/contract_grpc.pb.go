...
const (
	Contract_AddContract_FullMethodName    = "/bilibili.polymer.contract.v1.Contract/AddContract"
	Contract_AddContractV2_FullMethodName  = "/bilibili.polymer.contract.v1.Contract/AddContractV2"
	Contract_ContractConfig_FullMethodName = "/bilibili.polymer.contract.v1.Contract/ContractConfig"
)
...
func (UnimplementedContractServer) AddContract(context.Context, *AddContractReq) (*emptypb.Empty, error) {
